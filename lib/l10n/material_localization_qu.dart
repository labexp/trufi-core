...
/// A custom set of date patterns for the `qu` locale.
///
...
/// A custom set of date symbols for the `qu` locale.
///
...
class _QuMaterialLocalizationsDelegate
    extends LocalizationsDelegate<MaterialLocalizations> {
  const _QuMaterialLocalizationsDelegate();
  ...
  @override
  bool shouldReload(_QuMaterialLocalizationsDelegate old) => false;
}
...
class QuMaterialLocalizations extends GlobalMaterialLocalizations {
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate =
      _QuMaterialLocalizationsDelegate();
